...
def add(lhs: AFArray, rhs: AFArray, /) -> AFArray:
    ...
    """
    return binary_op(_backend.clib.af_add, lhs, rhs)
...
def bitshiftl(lhs: AFArray, rhs: AFArray, /) -> AFArray:
    ...
    """
    return binary_op(_backend.clib.af_bitshiftl, lhs, rhs)
...
def bitshiftr(lhs: AFArray, rhs: AFArray, /) -> AFArray:
    ...
    """
    return binary_op(_backend.clib.af_bitshiftr, lhs, rhs)
...
def div(lhs: AFArray, rhs: AFArray, /) -> AFArray:
    ...
    """
    return binary_op(_backend.clib.af_div, lhs, rhs)
...
def mul(lhs: AFArray, rhs: AFArray, /) -> AFArray:
    ...
    """
    return binary_op(_backend.clib.af_mul, lhs, rhs)
...
def sub(lhs: AFArray, rhs: AFArray, /) -> AFArray:
    ...
    """
    return binary_op(_backend.clib.af_sub, lhs, rhs)
